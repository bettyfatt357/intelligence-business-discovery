...
import { createDiscoveryRecords } from './discovery-factory';
...
export async function performSearch(
  ...
  try {
    ...
    // Step 3: Extract URLs and create DiscoveryRecords
    ...
    console.log('[SEARCH] Creating DiscoveryRecords...');
    ...
    console.log(`[SEARCH] Created ${discoveryRecords.length} DiscoveryRecords`);
    ...
    // Step 6: Add jobs to queue with DiscoveryRecords
    const jobIds: string[] = [];
    ...
    for (let i = 0; i < filteredUrls.length; i++) {
      ...
      try {
        ...
        // Get corresponding DiscoveryRecord (Phase 2B)
        const discoveryRecord = discoveryRecords[i];
        ...
        // Add to queue with discovery data
